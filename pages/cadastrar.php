        ...
        <div class="col-lg-8">
            ...
            <div class="card p-4 p-md-5" style="border-radius: var(--radius-lg); box-shadow: var(--shadow-md);">
                <form action="../includes/salvar_pedido.php" method="POST" id="form-cadastro" class="row g-4">
                    ...
                    <div class="col-md-6 form-floating"> 
                        <input type="tel" class="form-control <?php echo isset($erros['whatsapp']) ? 'is-invalid' : ''; ?>" id="whatsapp" name="whatsapp" value="<?php echo old('whatsapp', $old_data); ?>" placeholder="Seu Número de WhatsApp" required>
