...
require_once 'geocoding.php'; // Inclui o serviço de geocoding
...
// Validação (agora SÓ valida o CEP, não cidade/estado)
$erros = [];
...
// Chama a função de Geocoding (Backend faz tudo)
...
$result = @pg_execute($conn, "insert_pedido_geo", array(
    ...
    empty($cep_limpo) ? null : $cep, // Salva o CEP formatado ou NULL
    $cidade, 
    $estado, 
    $latitude, 
    $longitude
